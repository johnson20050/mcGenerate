...
# with command line options: Configuration/GenProduction/python/LambdaBToJPsiLambda.py --fileout file:step1.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step GEN,SIM --magField 38T_PostLS1 --no_exec -n 10000
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Spring 2016: Pythia8+EvtGen130 generation of Lb --> JPsi Lambda0, 13TeV, Tune CUETP8M1'),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PTFilter:filter = on', 
