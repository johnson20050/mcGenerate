...
# with command line options: Configuration/GenProduction/python/fullRandom_2pi.py --fileout file:step1.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step GEN,SIM --magField 38T_PostLS1 --no_exec -n 50000
...
options.register ('seed',
                        ...
                        "random seed for generate MC")
options.register ('nEvents',
                        10000,
                        VarParsing.multiplicity.singleton,
                        VarParsing.varType.int,
                        "number of events generating")
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_'+str(options.seed)+'.root'),
...
process.Npifilter = cms.EDFilter("PythiaDauVFilter",
    PaticleID = cms.untracked.int32(-211),
    MinPt = cms.untracked.vdouble(0.6),
    verbose = cms.untracked.int32(1)
)


process.Ppifilter = cms.EDFilter("PythiaDauVFilter",
    PaticleID = cms.untracked.int32(211),
    MinPt = cms.untracked.vdouble(0.6),
    verbose = cms.untracked.int32(1)
)
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    crossSection = cms.untracked.double(568000000.0),
...
#process.ProductionFilterSequence = cms.Sequence(process.generator+process.jpsifilter+process.Ppifilter+process.Npifilter)
process.ProductionFilterSequence = cms.Sequence(process.generator+process.jpsifilter)
