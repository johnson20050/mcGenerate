...
# with command line options: Configuration/GenProduction/python/LambdaBToJPsiPK.py --fileout file:step1.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step GEN,SIM --magField 38T_PostLS1 --no_exec -n 10000
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ExternalDecays = cms.PSet(
        ...
        EvtGen130 = cms.untracked.PSet(
            ...
            user_decay_file = cms.vstring('GeneratorInterface/ExternalDecays/data/LambdaB_JPsiKp.dec'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.bfilter+process.lbfilter+process.jpsifilter)
