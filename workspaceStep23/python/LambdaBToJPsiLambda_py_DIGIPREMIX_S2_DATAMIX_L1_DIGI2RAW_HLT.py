...
# Input source
from generaterFileList.generaterFileList.step1Files import readFiles
process.source = cms.Source("PoolSource",
    #fileNames = readFiles,
    fileNames=cms.untracked.vstring('file:///home/ltsai/ReceivedFile/step1_LbL0.root'),
...
# Other statements
from generaterFileList.generaterFileList.pileUpFiles import loadFiles
process.mix.digitizers = cms.PSet(process.theDigitizersMixPreMix)
process.mixData.input.fileNames = loadFiles
...
process.options.numberOfThreads=cms.untracked.uint32(3)
